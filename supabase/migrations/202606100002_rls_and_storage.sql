...
revoke all on function public.is_collection_member(uuid) from anon;
revoke all on function public.is_collection_owner(uuid) from anon;
revoke all on function public.shares_collection_with(uuid) from anon;
revoke all on function public.can_access_clue_image_object(text) from anon;
